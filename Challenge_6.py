...
def applyForAJob(choice):
    # for loop and read file first
    # whenever you read each line split by tab
    # the last is going to be the job applicants entry
    # names within job applicant entry are going to be split by commas
    i = 1
        ...
        while not it_is:
            ...
            if it_is:
                ...
                if (choiceToApply < 0) or (choiceToApply > 2):
                    ...
                    it_is = False
        if choiceToApply == 1:
            print("execute application function")
        else:
            menu()
