...
def test_send_Message_to_friends_mailbox():
    ...
    Challenge_7.userName = "bradfordd"
    Challenge_7.subscription = "S"
    Challenge_7.sendMessage()
...
def test_view_and_delete_message():
    ...
    Challenge_7.userName = "bradforda"
    Challenge_7.subscription = "S"
    Challenge_7.viewMessages();
    output = get_display_output()
    assert output == [
                        '\n'
...
def test_send_messages_to_all_with_premium_account():
    set_keyboard_input(["1", "I like pie", "3", "13"])
    Challenge_7.userName = "plusmember"
    Challenge_7.subscription = "P"
    output = get_display_output()
    Challenge_7.sendMessage()
    output = get_display_output()
    assert output == [ 'P',
